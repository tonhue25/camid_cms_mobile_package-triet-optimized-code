...
/**
 * The persistent class for the MB_POSTPAID_SMS_UNRATED database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_SMS_UNRATED")
@NamedQuery(name="MbPostpaidSmsUnrated.findAll", query="SELECT m FROM MbPostpaidSmsUnrated m")
public class MbPostpaidSmsUnrated implements Serializable {
