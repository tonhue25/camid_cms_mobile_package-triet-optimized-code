...
/**
 * The persistent class for the PSTN_LOCAL_CALL_REIMP database table.
 * 
 */
@Entity
@Table(name="PSTN_LOCAL_CALL_REIMP")
@NamedQuery(name="PstnLocalCallReimp.findAll", query="SELECT p FROM PstnLocalCallReimp p")
public class PstnLocalCallReimp implements Serializable {
