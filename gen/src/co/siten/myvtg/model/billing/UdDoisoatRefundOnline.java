...
/**
 * The persistent class for the UD_DOISOAT_REFUND_ONLINE database table.
 * 
 */
@Entity
@Table(name="UD_DOISOAT_REFUND_ONLINE")
@NamedQuery(name="UdDoisoatRefundOnline.findAll", query="SELECT u FROM UdDoisoatRefundOnline u")
public class UdDoisoatRefundOnline implements Serializable {
