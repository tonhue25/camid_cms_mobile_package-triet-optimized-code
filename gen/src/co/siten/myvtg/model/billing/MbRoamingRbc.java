...
/**
 * The persistent class for the MB_ROAMING_RBC database table.
 * 
 */
@Entity
@Table(name="MB_ROAMING_RBC")
@NamedQuery(name="MbRoamingRbc.findAll", query="SELECT m FROM MbRoamingRbc m")
public class MbRoamingRbc implements Serializable {
