...
/**
 * The persistent class for the SUB_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE")
@NamedQuery(name="SubUsageCharge.findAll", query="SELECT s FROM SubUsageCharge s")
public class SubUsageCharge implements Serializable {
