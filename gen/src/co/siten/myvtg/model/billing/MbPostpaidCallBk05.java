...
/**
 * The persistent class for the MB_POSTPAID_CALL_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL_BK05")
@NamedQuery(name="MbPostpaidCallBk05.findAll", query="SELECT m FROM MbPostpaidCallBk05 m")
public class MbPostpaidCallBk05 implements Serializable {
