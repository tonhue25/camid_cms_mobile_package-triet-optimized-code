...
/**
 * The persistent class for the SUB_USAGE_CHARGE4 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE4")
@NamedQuery(name="SubUsageCharge4.findAll", query="SELECT s FROM SubUsageCharge4 s")
public class SubUsageCharge4 implements Serializable {
