...
/**
 * The persistent class for the SUB_USAGE_CHARGE_DISCOUNT_LOCK database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_DISCOUNT_LOCK")
@NamedQuery(name="SubUsageChargeDiscountLock.findAll", query="SELECT s FROM SubUsageChargeDiscountLock s")
public class SubUsageChargeDiscountLock implements Serializable {
	...
	public SubUsageChargeDiscountLock() {
	}
