...
/**
 * The persistent class for the PSTN_POSTPAID_CALL database table.
 * 
 */
@Entity
@Table(name="PSTN_POSTPAID_CALL")
@NamedQuery(name="PstnPostpaidCall.findAll", query="SELECT p FROM PstnPostpaidCall p")
public class PstnPostpaidCall implements Serializable {
