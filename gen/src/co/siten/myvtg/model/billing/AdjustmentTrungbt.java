...
/**
 * The persistent class for the ADJUSTMENT_TRUNGBT database table.
 * 
 */
@Entity
@Table(name="ADJUSTMENT_TRUNGBT")
@NamedQuery(name="AdjustmentTrungbt.findAll", query="SELECT a FROM AdjustmentTrungbt a")
public class AdjustmentTrungbt implements Serializable {
