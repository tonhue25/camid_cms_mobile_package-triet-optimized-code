...
/**
 * The persistent class for the V_H_CUSTOMERCARE_ALL database table.
 * 
 */
@Entity
@Table(name="V_H_CUSTOMERCARE_ALL")
@NamedQuery(name="VHCustomercareAll.findAll", query="SELECT v FROM VHCustomercareAll v")
public class VHCustomercareAll implements Serializable {
