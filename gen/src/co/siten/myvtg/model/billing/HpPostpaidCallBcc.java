...
/**
 * The persistent class for the HP_POSTPAID_CALL_BCCS database table.
 * 
 */
@Entity
@Table(name="HP_POSTPAID_CALL_BCCS")
@NamedQuery(name="HpPostpaidCallBcc.findAll", query="SELECT h FROM HpPostpaidCallBcc h")
public class HpPostpaidCallBcc implements Serializable {
