...
/**
 * The persistent class for the MB_POSTPAID_SMS_BK_052016 database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_SMS_BK_052016")
@NamedQuery(name="MbPostpaidSmsBk052016.findAll", query="SELECT m FROM MbPostpaidSmsBk052016 m")
public class MbPostpaidSmsBk052016 implements Serializable {
