...
/**
 * The persistent class for the SUB_USAGE_CHARGE_DISROAM_CLOSE database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_DISROAM_CLOSE")
@NamedQuery(name="SubUsageChargeDisroamClose.findAll", query="SELECT s FROM SubUsageChargeDisroamClose s")
public class SubUsageChargeDisroamClose implements Serializable {
	...
	public SubUsageChargeDisroamClose() {
	}
