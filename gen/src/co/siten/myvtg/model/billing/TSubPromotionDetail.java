...
/**
 * The persistent class for the T_SUB_PROMOTION_DETAIL database table.
 * 
 */
@Entity
@Table(name="T_SUB_PROMOTION_DETAIL")
@NamedQuery(name="TSubPromotionDetail.findAll", query="SELECT t FROM TSubPromotionDetail t")
public class TSubPromotionDetail implements Serializable {
