...
/**
 * The persistent class for the PRINT_TEXT_BK29052015 database table.
 * 
 */
@Entity
@Table(name="PRINT_TEXT_BK29052015")
@NamedQuery(name="PrintTextBk29052015.findAll", query="SELECT p FROM PrintTextBk29052015 p")
public class PrintTextBk29052015 implements Serializable {
