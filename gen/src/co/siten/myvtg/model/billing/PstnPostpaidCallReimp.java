...
/**
 * The persistent class for the PSTN_POSTPAID_CALL_REIMP database table.
 * 
 */
@Entity
@Table(name="PSTN_POSTPAID_CALL_REIMP")
@NamedQuery(name="PstnPostpaidCallReimp.findAll", query="SELECT p FROM PstnPostpaidCallReimp p")
public class PstnPostpaidCallReimp implements Serializable {
