...
/**
 * The persistent class for the V_MB_CUSTOMERCARE_CALL database table.
 * 
 */
@Entity
@Table(name="V_MB_CUSTOMERCARE_CALL")
@NamedQuery(name="VMbCustomercareCall.findAll", query="SELECT v FROM VMbCustomercareCall v")
public class VMbCustomercareCall implements Serializable {
