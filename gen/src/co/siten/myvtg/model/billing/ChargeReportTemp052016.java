...
/**
 * The persistent class for the CHARGE_REPORT_TEMP_052016 database table.
 * 
 */
@Entity
@Table(name="CHARGE_REPORT_TEMP_052016")
@NamedQuery(name="ChargeReportTemp052016.findAll", query="SELECT c FROM ChargeReportTemp052016 c")
public class ChargeReportTemp052016 implements Serializable {
