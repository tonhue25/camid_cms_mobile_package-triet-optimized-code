...
/**
 * The persistent class for the HP_POSTPAID_CALL_REIMP database table.
 * 
 */
@Entity
@Table(name="HP_POSTPAID_CALL_REIMP")
@NamedQuery(name="HpPostpaidCallReimp.findAll", query="SELECT h FROM HpPostpaidCallReimp h")
public class HpPostpaidCallReimp implements Serializable {
