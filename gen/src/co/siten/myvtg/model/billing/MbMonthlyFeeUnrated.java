...
/**
 * The persistent class for the MB_MONTHLY_FEE_UNRATED database table.
 * 
 */
@Entity
@Table(name="MB_MONTHLY_FEE_UNRATED")
@NamedQuery(name="MbMonthlyFeeUnrated.findAll", query="SELECT m FROM MbMonthlyFeeUnrated m")
public class MbMonthlyFeeUnrated implements Serializable {
