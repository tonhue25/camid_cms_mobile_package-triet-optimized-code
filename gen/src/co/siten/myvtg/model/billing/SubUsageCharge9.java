...
/**
 * The persistent class for the SUB_USAGE_CHARGE9 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE9")
@NamedQuery(name="SubUsageCharge9.findAll", query="SELECT s FROM SubUsageCharge9 s")
public class SubUsageCharge9 implements Serializable {
