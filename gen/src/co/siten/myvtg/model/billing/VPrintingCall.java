...
/**
 * The persistent class for the V_PRINTING_CALL database table.
 * 
 */
@Entity
@Table(name="V_PRINTING_CALL")
@NamedQuery(name="VPrintingCall.findAll", query="SELECT v FROM VPrintingCall v")
public class VPrintingCall implements Serializable {
