...
/**
 * The persistent class for the SUB_USAGE_CHARGE7 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE7")
@NamedQuery(name="SubUsageCharge7.findAll", query="SELECT s FROM SubUsageCharge7 s")
public class SubUsageCharge7 implements Serializable {
