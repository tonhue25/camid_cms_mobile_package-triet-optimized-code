...
/**
 * The persistent class for the V_MB_CUSTOMERCARE_ALL database table.
 * 
 */
@Entity
@Table(name="V_MB_CUSTOMERCARE_ALL")
@NamedQuery(name="VMbCustomercareAll.findAll", query="SELECT v FROM VMbCustomercareAll v")
public class VMbCustomercareAll implements Serializable {
