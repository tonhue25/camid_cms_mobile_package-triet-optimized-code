...
/**
 * The persistent class for the PHUNH3_ADJUSTMENT database table.
 * 
 */
@Entity
@Table(name="PHUNH3_ADJUSTMENT")
@NamedQuery(name="Phunh3Adjustment.findAll", query="SELECT p FROM Phunh3Adjustment p")
public class Phunh3Adjustment implements Serializable {
