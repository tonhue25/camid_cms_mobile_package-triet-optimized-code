...
/**
 * The persistent class for the MB_POSTPAID_SMS_BK database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_SMS_BK")
@NamedQuery(name="MbPostpaidSmsBk.findAll", query="SELECT m FROM MbPostpaidSmsBk m")
public class MbPostpaidSmsBk implements Serializable {
