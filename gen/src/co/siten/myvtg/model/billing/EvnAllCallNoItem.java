...
/**
 * The persistent class for the EVN_ALL_CALL_NO_ITEM database table.
 * 
 */
@Entity
@Table(name="EVN_ALL_CALL_NO_ITEM")
@NamedQuery(name="EvnAllCallNoItem.findAll", query="SELECT e FROM EvnAllCallNoItem e")
public class EvnAllCallNoItem implements Serializable {
