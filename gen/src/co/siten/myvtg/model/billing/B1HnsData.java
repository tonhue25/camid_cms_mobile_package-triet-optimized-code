...
/**
 * The persistent class for the B1_HNS_DATA database table.
 * 
 */
@Entity
@Table(name="B1_HNS_DATA")
@NamedQuery(name="B1HnsData.findAll", query="SELECT b FROM B1HnsData b")
public class B1HnsData implements Serializable {
