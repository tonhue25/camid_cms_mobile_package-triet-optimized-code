...
/**
 * The persistent class for the EMAIL_CHARGE_REPORT database table.
 * 
 */
@Entity
@Table(name="EMAIL_CHARGE_REPORT")
@NamedQuery(name="EmailChargeReport.findAll", query="SELECT e FROM EmailChargeReport e")
public class EmailChargeReport implements Serializable {
