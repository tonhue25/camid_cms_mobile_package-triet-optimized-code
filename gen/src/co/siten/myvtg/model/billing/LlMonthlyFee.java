...
/**
 * The persistent class for the LL_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="LL_MONTHLY_FEE")
@NamedQuery(name="LlMonthlyFee.findAll", query="SELECT l FROM LlMonthlyFee l")
public class LlMonthlyFee implements Serializable {
