...
/**
 * The persistent class for the MAP_ITEM_MB database table.
 * 
 */
@Entity
@Table(name="MAP_ITEM_MB")
@NamedQuery(name="MapItemMb.findAll", query="SELECT m FROM MapItemMb m")
public class MapItemMb implements Serializable {
