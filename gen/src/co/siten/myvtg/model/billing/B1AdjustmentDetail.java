...
/**
 * The persistent class for the B1_ADJUSTMENT_DETAIL database table.
 * 
 */
@Entity
@Table(name="B1_ADJUSTMENT_DETAIL")
@NamedQuery(name="B1AdjustmentDetail.findAll", query="SELECT b FROM B1AdjustmentDetail b")
public class B1AdjustmentDetail implements Serializable {
