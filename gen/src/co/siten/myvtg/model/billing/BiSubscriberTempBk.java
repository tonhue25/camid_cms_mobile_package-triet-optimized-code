...
/**
 * The persistent class for the BI_SUBSCRIBER_TEMP_BK database table.
 * 
 */
@Entity
@Table(name="BI_SUBSCRIBER_TEMP_BK")
@NamedQuery(name="BiSubscriberTempBk.findAll", query="SELECT b FROM BiSubscriberTempBk b")
public class BiSubscriberTempBk implements Serializable {
