...
/**
 * The persistent class for the MB_POSTPAID_CALL_345 database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL_345")
@NamedQuery(name="MbPostpaidCall345.findAll", query="SELECT m FROM MbPostpaidCall345 m")
public class MbPostpaidCall345 implements Serializable {
