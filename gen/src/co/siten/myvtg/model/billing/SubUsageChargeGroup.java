...
/**
 * The persistent class for the SUB_USAGE_CHARGE_GROUP database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_GROUP")
@NamedQuery(name="SubUsageChargeGroup.findAll", query="SELECT s FROM SubUsageChargeGroup s")
public class SubUsageChargeGroup implements Serializable {
