...
/**
 * The persistent class for the SUB_USAGE_CHARGE_ROAMING database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_ROAMING")
@NamedQuery(name="SubUsageChargeRoaming.findAll", query="SELECT s FROM SubUsageChargeRoaming s")
public class SubUsageChargeRoaming implements Serializable {
