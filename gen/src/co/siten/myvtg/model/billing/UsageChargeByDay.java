...
/**
 * The persistent class for the USAGE_CHARGE_BY_DAY database table.
 * 
 */
@Entity
@Table(name="USAGE_CHARGE_BY_DAY")
@NamedQuery(name="UsageChargeByDay.findAll", query="SELECT u FROM UsageChargeByDay u")
public class UsageChargeByDay implements Serializable {
