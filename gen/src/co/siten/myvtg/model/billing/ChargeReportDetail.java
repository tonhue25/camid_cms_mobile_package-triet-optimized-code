...
/**
 * The persistent class for the CHARGE_REPORT_DETAIL database table.
 * 
 */
@Entity
@Table(name="CHARGE_REPORT_DETAIL")
@NamedQuery(name="ChargeReportDetail.findAll", query="SELECT c FROM ChargeReportDetail c")
public class ChargeReportDetail implements Serializable {
