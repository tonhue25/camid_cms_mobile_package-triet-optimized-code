...
/**
 * The persistent class for the PSTN_CHAN_SUB database table.
 * 
 */
@Entity
@Table(name="PSTN_CHAN_SUB")
@NamedQuery(name="PstnChanSub.findAll", query="SELECT p FROM PstnChanSub p")
public class PstnChanSub implements Serializable {
