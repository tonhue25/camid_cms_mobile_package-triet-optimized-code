...
/**
 * The persistent class for the SUB_USAGE_CHARGE1 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE1")
@NamedQuery(name="SubUsageCharge1.findAll", query="SELECT s FROM SubUsageCharge1 s")
public class SubUsageCharge1 implements Serializable {
