...
/**
 * The persistent class for the MB_POSTPAID_CALL_BK_052016 database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL_BK_052016")
@NamedQuery(name="MbPostpaidCallBk052016.findAll", query="SELECT m FROM MbPostpaidCallBk052016 m")
public class MbPostpaidCallBk052016 implements Serializable {
