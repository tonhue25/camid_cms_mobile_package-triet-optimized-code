...
/**
 * The persistent class for the MB_ROAMING_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_ROAMING_BK05")
@NamedQuery(name="MbRoamingBk05.findAll", query="SELECT m FROM MbRoamingBk05 m")
public class MbRoamingBk05 implements Serializable {
