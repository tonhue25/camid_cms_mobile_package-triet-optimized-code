...
/**
 * The persistent class for the TMP_THANG_SUM_MB_POSTPAID_CALL database table.
 * 
 */
@Entity
@Table(name="TMP_THANG_SUM_MB_POSTPAID_CALL")
@NamedQuery(name="TmpThangSumMbPostpaidCall.findAll", query="SELECT t FROM TmpThangSumMbPostpaidCall t")
public class TmpThangSumMbPostpaidCall implements Serializable {
	...
	public TmpThangSumMbPostpaidCall() {
	}
