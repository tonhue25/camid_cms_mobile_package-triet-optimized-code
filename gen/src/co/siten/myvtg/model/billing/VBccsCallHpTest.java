...
/**
 * The persistent class for the V_BCCS_CALL_HP_TEST database table.
 * 
 */
@Entity
@Table(name="V_BCCS_CALL_HP_TEST")
@NamedQuery(name="VBccsCallHpTest.findAll", query="SELECT v FROM VBccsCallHpTest v")
public class VBccsCallHpTest implements Serializable {
