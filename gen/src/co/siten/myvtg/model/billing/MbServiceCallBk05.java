...
/**
 * The persistent class for the MB_SERVICE_CALL_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_SERVICE_CALL_BK05")
@NamedQuery(name="MbServiceCallBk05.findAll", query="SELECT m FROM MbServiceCallBk05 m")
public class MbServiceCallBk05 implements Serializable {
