...
/**
 * The persistent class for the MB_GPRS_UNRATED database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_UNRATED")
@NamedQuery(name="MbGprsUnrated.findAll", query="SELECT m FROM MbGprsUnrated m")
public class MbGprsUnrated implements Serializable {
