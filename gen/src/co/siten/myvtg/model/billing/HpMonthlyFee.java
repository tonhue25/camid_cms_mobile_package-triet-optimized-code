...
/**
 * The persistent class for the HP_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="HP_MONTHLY_FEE")
@NamedQuery(name="HpMonthlyFee.findAll", query="SELECT h FROM HpMonthlyFee h")
public class HpMonthlyFee implements Serializable {
