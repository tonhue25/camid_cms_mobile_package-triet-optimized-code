...
/**
 * The persistent class for the SUB_USAGE_CHARGE_345 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_345")
@NamedQuery(name="SubUsageCharge345.findAll", query="SELECT s FROM SubUsageCharge345 s")
public class SubUsageCharge345 implements Serializable {
