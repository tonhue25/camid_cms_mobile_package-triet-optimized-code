...
/**
 * The persistent class for the V_CUSTOMERCARE_VAS database table.
 * 
 */
@Entity
@Table(name="V_CUSTOMERCARE_VAS")
@NamedQuery(name="VCustomercareVa.findAll", query="SELECT v FROM VCustomercareVa v")
public class VCustomercareVa implements Serializable {
