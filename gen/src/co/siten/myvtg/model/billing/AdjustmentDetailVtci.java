...
/**
 * The persistent class for the ADJUSTMENT_DETAIL_VTCI database table.
 * 
 */
@Entity
@Table(name="ADJUSTMENT_DETAIL_VTCI")
@NamedQuery(name="AdjustmentDetailVtci.findAll", query="SELECT a FROM AdjustmentDetailVtci a")
public class AdjustmentDetailVtci implements Serializable {
