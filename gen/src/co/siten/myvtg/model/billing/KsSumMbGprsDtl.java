...
/**
 * The persistent class for the KS_SUM_MB_GPRS_DTL database table.
 * 
 */
@Entity
@Table(name="KS_SUM_MB_GPRS_DTL")
@NamedQuery(name="KsSumMbGprsDtl.findAll", query="SELECT k FROM KsSumMbGprsDtl k")
public class KsSumMbGprsDtl implements Serializable {
