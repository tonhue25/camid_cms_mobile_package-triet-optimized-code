...
/**
 * The persistent class for the PRINT_OBJECT_BK29052015 database table.
 * 
 */
@Entity
@Table(name="PRINT_OBJECT_BK29052015")
@NamedQuery(name="PrintObjectBk29052015.findAll", query="SELECT p FROM PrintObjectBk29052015 p")
public class PrintObjectBk29052015 implements Serializable {
