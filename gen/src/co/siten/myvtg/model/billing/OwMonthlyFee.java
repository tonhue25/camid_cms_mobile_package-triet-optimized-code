...
/**
 * The persistent class for the OW_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="OW_MONTHLY_FEE")
@NamedQuery(name="OwMonthlyFee.findAll", query="SELECT o FROM OwMonthlyFee o")
public class OwMonthlyFee implements Serializable {
