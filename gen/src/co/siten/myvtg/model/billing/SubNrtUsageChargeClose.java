...
/**
 * The persistent class for the SUB_NRT_USAGE_CHARGE_CLOSE database table.
 * 
 */
@Entity
@Table(name="SUB_NRT_USAGE_CHARGE_CLOSE")
@NamedQuery(name="SubNrtUsageChargeClose.findAll", query="SELECT s FROM SubNrtUsageChargeClose s")
public class SubNrtUsageChargeClose implements Serializable {
