...
/**
 * The persistent class for the V_P_CUSTOMERCARE_ALL database table.
 * 
 */
@Entity
@Table(name="V_P_CUSTOMERCARE_ALL")
@NamedQuery(name="VPCustomercareAll.findAll", query="SELECT v FROM VPCustomercareAll v")
public class VPCustomercareAll implements Serializable {
