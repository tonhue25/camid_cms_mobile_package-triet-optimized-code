...
/**
 * The persistent class for the MB_MONTHLY_FEE_BK_052016 database table.
 * 
 */
@Entity
@Table(name="MB_MONTHLY_FEE_BK_052016")
@NamedQuery(name="MbMonthlyFeeBk052016.findAll", query="SELECT m FROM MbMonthlyFeeBk052016 m")
public class MbMonthlyFeeBk052016 implements Serializable {
