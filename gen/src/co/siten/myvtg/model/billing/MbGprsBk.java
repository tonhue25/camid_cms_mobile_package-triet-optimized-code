...
/**
 * The persistent class for the MB_GPRS_BK database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_BK")
@NamedQuery(name="MbGprsBk.findAll", query="SELECT m FROM MbGprsBk m")
public class MbGprsBk implements Serializable {
