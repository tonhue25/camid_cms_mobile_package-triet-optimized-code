...
/**
 * The persistent class for the MB_SERVICE_CALL_UNRATED database table.
 * 
 */
@Entity
@Table(name="MB_SERVICE_CALL_UNRATED")
@NamedQuery(name="MbServiceCallUnrated.findAll", query="SELECT m FROM MbServiceCallUnrated m")
public class MbServiceCallUnrated implements Serializable {
