...
/**
 * The persistent class for the KS_SUM_MB_POSTPAID_SMS_DTL database table.
 * 
 */
@Entity
@Table(name="KS_SUM_MB_POSTPAID_SMS_DTL")
@NamedQuery(name="KsSumMbPostpaidSmsDtl.findAll", query="SELECT k FROM KsSumMbPostpaidSmsDtl k")
public class KsSumMbPostpaidSmsDtl implements Serializable {
