...
/**
 * The persistent class for the PSTN_POSTPAID_CALL_MIG_UNRATED database table.
 * 
 */
@Entity
@Table(name="PSTN_POSTPAID_CALL_MIG_UNRATED")
@NamedQuery(name="PstnPostpaidCallMigUnrated.findAll", query="SELECT p FROM PstnPostpaidCallMigUnrated p")
public class PstnPostpaidCallMigUnrated implements Serializable {
	...
	@Column(name="TRUNK_IN")
	private String trunkIn;

	@Column(name="TRUNK_OUT")
	private String trunkOut;

	@Column(name="\"TYPE\"")
	private String type;

	public PstnPostpaidCallMigUnrated() {
	}
	...
	public void setTrunkIn(String trunkIn) {
	...
	public void setTrunkOut(String trunkOut) {
