...
/**
 * The persistent class for the SUB_USAGE_CHARGE_BK_052016 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_BK_052016")
@NamedQuery(name="SubUsageChargeBk052016.findAll", query="SELECT s FROM SubUsageChargeBk052016 s")
public class SubUsageChargeBk052016 implements Serializable {
