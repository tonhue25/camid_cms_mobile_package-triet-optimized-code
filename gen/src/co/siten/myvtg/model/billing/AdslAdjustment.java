...
/**
 * The persistent class for the ADSL_ADJUSTMENT database table.
 * 
 */
@Entity
@Table(name="ADSL_ADJUSTMENT")
@NamedQuery(name="AdslAdjustment.findAll", query="SELECT a FROM AdslAdjustment a")
public class AdslAdjustment implements Serializable {
