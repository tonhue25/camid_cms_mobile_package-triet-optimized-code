...
/**
 * The persistent class for the TINHLAI_TIMEZONE database table.
 * 
 */
@Entity
@Table(name="TINHLAI_TIMEZONE")
@NamedQuery(name="TinhlaiTimezone.findAll", query="SELECT t FROM TinhlaiTimezone t")
public class TinhlaiTimezone implements Serializable {
