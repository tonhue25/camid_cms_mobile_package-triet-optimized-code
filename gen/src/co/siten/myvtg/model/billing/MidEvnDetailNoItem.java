...
/**
 * The persistent class for the MID_EVN_DETAIL_NO_ITEM database table.
 * 
 */
@Entity
@Table(name="MID_EVN_DETAIL_NO_ITEM")
@NamedQuery(name="MidEvnDetailNoItem.findAll", query="SELECT m FROM MidEvnDetailNoItem m")
public class MidEvnDetailNoItem implements Serializable {
