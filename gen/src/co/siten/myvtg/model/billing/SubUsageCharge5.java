...
/**
 * The persistent class for the SUB_USAGE_CHARGE5 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE5")
@NamedQuery(name="SubUsageCharge5.findAll", query="SELECT s FROM SubUsageCharge5 s")
public class SubUsageCharge5 implements Serializable {
