...
/**
 * The persistent class for the SUB_PROMOTION_DETAIL database table.
 * 
 */
@Entity
@Table(name="SUB_PROMOTION_DETAIL")
@NamedQuery(name="SubPromotionDetail.findAll", query="SELECT s FROM SubPromotionDetail s")
public class SubPromotionDetail implements Serializable {
