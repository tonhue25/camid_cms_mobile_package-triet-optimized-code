...
/**
 * The persistent class for the BI_CONTRACT_TEMP database table.
 * 
 */
@Entity
@Table(name="BI_CONTRACT_TEMP")
@NamedQuery(name="BiContractTemp.findAll", query="SELECT b FROM BiContractTemp b")
public class BiContractTemp implements Serializable {
	...
	@Column(name="CHECK_PAYMENT_ORDER")
	private String checkPaymentOrder;
	...
	public String getCheckPaymentOrder() {
		return this.checkPaymentOrder;
	}

	public void setCheckPaymentOrder(String checkPaymentOrder) {
		this.checkPaymentOrder = checkPaymentOrder;
	}
