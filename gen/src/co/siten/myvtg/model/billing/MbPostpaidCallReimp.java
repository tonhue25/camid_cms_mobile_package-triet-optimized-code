...
/**
 * The persistent class for the MB_POSTPAID_CALL_REIMP database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL_REIMP")
@NamedQuery(name="MbPostpaidCallReimp.findAll", query="SELECT m FROM MbPostpaidCallReimp m")
public class MbPostpaidCallReimp implements Serializable {
