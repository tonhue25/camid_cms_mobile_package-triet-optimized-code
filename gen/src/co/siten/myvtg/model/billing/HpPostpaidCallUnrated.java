...
/**
 * The persistent class for the HP_POSTPAID_CALL_UNRATED database table.
 * 
 */
@Entity
@Table(name="HP_POSTPAID_CALL_UNRATED")
@NamedQuery(name="HpPostpaidCallUnrated.findAll", query="SELECT h FROM HpPostpaidCallUnrated h")
public class HpPostpaidCallUnrated implements Serializable {
