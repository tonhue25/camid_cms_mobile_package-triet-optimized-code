...
/**
 * The persistent class for the SUB_USAGE_CHARGE_SERVICE database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_SERVICE")
@NamedQuery(name="SubUsageChargeService.findAll", query="SELECT s FROM SubUsageChargeService s")
public class SubUsageChargeService implements Serializable {
