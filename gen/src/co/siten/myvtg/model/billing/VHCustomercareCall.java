...
/**
 * The persistent class for the V_H_CUSTOMERCARE_CALL database table.
 * 
 */
@Entity
@Table(name="V_H_CUSTOMERCARE_CALL")
@NamedQuery(name="VHCustomercareCall.findAll", query="SELECT v FROM VHCustomercareCall v")
public class VHCustomercareCall implements Serializable {
