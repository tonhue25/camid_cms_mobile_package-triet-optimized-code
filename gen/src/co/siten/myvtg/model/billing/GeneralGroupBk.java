...
/**
 * The persistent class for the GENERAL_GROUP_BK database table.
 * 
 */
@Entity
@Table(name="GENERAL_GROUP_BK")
@NamedQuery(name="GeneralGroupBk.findAll", query="SELECT g FROM GeneralGroupBk g")
public class GeneralGroupBk implements Serializable {
