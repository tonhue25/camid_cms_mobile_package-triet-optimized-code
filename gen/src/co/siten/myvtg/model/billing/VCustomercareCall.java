...
/**
 * The persistent class for the V_CUSTOMERCARE_CALL database table.
 * 
 */
@Entity
@Table(name="V_CUSTOMERCARE_CALL")
@NamedQuery(name="VCustomercareCall.findAll", query="SELECT v FROM VCustomercareCall v")
public class VCustomercareCall implements Serializable {
