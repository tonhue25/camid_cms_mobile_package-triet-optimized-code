...
/**
 * The persistent class for the PSTN_VAS_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="PSTN_VAS_MONTHLY_FEE")
@NamedQuery(name="PstnVasMonthlyFee.findAll", query="SELECT p FROM PstnVasMonthlyFee p")
public class PstnVasMonthlyFee implements Serializable {
