...
/**
 * The persistent class for the SUB_USAGE_CHARGE_BK05 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_BK05")
@NamedQuery(name="SubUsageChargeBk05.findAll", query="SELECT s FROM SubUsageChargeBk05 s")
public class SubUsageChargeBk05 implements Serializable {
