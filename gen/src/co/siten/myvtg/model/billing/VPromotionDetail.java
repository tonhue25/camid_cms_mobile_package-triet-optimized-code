...
/**
 * The persistent class for the V_PROMOTION_DETAIL database table.
 * 
 */
@Entity
@Table(name="V_PROMOTION_DETAIL")
@NamedQuery(name="VPromotionDetail.findAll", query="SELECT v FROM VPromotionDetail v")
public class VPromotionDetail implements Serializable {
