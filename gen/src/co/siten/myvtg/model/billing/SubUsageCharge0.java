...
/**
 * The persistent class for the SUB_USAGE_CHARGE0 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE0")
@NamedQuery(name="SubUsageCharge0.findAll", query="SELECT s FROM SubUsageCharge0 s")
public class SubUsageCharge0 implements Serializable {
