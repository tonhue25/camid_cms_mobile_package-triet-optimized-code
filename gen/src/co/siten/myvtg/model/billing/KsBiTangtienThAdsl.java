...
/**
 * The persistent class for the KS_BI_TANGTIEN_TH_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_TANGTIEN_TH_ADSL")
@NamedQuery(name="KsBiTangtienThAdsl.findAll", query="SELECT k FROM KsBiTangtienThAdsl k")
public class KsBiTangtienThAdsl implements Serializable {
