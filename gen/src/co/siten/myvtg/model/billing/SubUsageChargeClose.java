...
/**
 * The persistent class for the SUB_USAGE_CHARGE_CLOSE database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_CLOSE")
@NamedQuery(name="SubUsageChargeClose.findAll", query="SELECT s FROM SubUsageChargeClose s")
public class SubUsageChargeClose implements Serializable {
