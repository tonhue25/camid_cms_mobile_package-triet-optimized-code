...
/**
 * The persistent class for the SUB_NRT_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="SUB_NRT_USAGE_CHARGE")
@NamedQuery(name="SubNrtUsageCharge.findAll", query="SELECT s FROM SubNrtUsageCharge s")
public class SubNrtUsageCharge implements Serializable {
