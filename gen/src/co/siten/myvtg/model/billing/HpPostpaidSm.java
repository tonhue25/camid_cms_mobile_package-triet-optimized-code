...
/**
 * The persistent class for the HP_POSTPAID_SMS database table.
 * 
 */
@Entity
@Table(name="HP_POSTPAID_SMS")
@NamedQuery(name="HpPostpaidSm.findAll", query="SELECT h FROM HpPostpaidSm h")
public class HpPostpaidSm implements Serializable {
	...
	private BigDecimal deductStatus;
	...
	public BigDecimal getDeductStatus() {
		return this.deductStatus;
	}

	public void setDeductStatus(BigDecimal deductStatus) {
