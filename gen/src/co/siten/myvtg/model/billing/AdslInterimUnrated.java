...
/**
 * The persistent class for the ADSL_INTERIM_UNRATED database table.
 * 
 */
@Entity
@Table(name="ADSL_INTERIM_UNRATED")
@NamedQuery(name="AdslInterimUnrated.findAll", query="SELECT a FROM AdslInterimUnrated a")
public class AdslInterimUnrated implements Serializable {
