...
/**
 * The persistent class for the SUB_USAGE_CHARGE2 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE2")
@NamedQuery(name="SubUsageCharge2.findAll", query="SELECT s FROM SubUsageCharge2 s")
public class SubUsageCharge2 implements Serializable {
