...
/**
 * The persistent class for the V_PRINTING_ROAMING_TUANTDT database table.
 * 
 */
@Entity
@Table(name="V_PRINTING_ROAMING_TUANTDT")
@NamedQuery(name="VPrintingRoamingTuantdt.findAll", query="SELECT v FROM VPrintingRoamingTuantdt v")
public class VPrintingRoamingTuantdt implements Serializable {
	...
	public VPrintingRoamingTuantdt() {
	}
