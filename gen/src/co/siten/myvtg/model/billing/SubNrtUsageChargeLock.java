...
/**
 * The persistent class for the SUB_NRT_USAGE_CHARGE_LOCK database table.
 * 
 */
@Entity
@Table(name="SUB_NRT_USAGE_CHARGE_LOCK")
@NamedQuery(name="SubNrtUsageChargeLock.findAll", query="SELECT s FROM SubNrtUsageChargeLock s")
public class SubNrtUsageChargeLock implements Serializable {
