...
/**
 * The persistent class for the SUB_USAGE_CHARGE_ROAMING_LOCK database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_ROAMING_LOCK")
@NamedQuery(name="SubUsageChargeRoamingLock.findAll", query="SELECT s FROM SubUsageChargeRoamingLock s")
public class SubUsageChargeRoamingLock implements Serializable {
	...
	public SubUsageChargeRoamingLock() {
	}
