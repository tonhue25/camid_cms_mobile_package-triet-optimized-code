...
/**
 * The persistent class for the HP_SERVICE_CALL database table.
 * 
 */
@Entity
@Table(name="HP_SERVICE_CALL")
@NamedQuery(name="HpServiceCall.findAll", query="SELECT h FROM HpServiceCall h")
public class HpServiceCall implements Serializable {
