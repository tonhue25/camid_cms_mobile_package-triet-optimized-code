...
/**
 * The persistent class for the SUC_SERVICE_12MAR database table.
 * 
 */
@Entity
@Table(name="SUC_SERVICE_12MAR")
@NamedQuery(name="SucService12mar.findAll", query="SELECT s FROM SucService12mar s")
public class SucService12mar implements Serializable {
