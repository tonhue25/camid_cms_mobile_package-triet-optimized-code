...
/**
 * The persistent class for the ADSL_ADJUSTMENT_DETAIL database table.
 * 
 */
@Entity
@Table(name="ADSL_ADJUSTMENT_DETAIL")
@NamedQuery(name="AdslAdjustmentDetail.findAll", query="SELECT a FROM AdslAdjustmentDetail a")
public class AdslAdjustmentDetail implements Serializable {
