...
/**
 * The persistent class for the V_HOMEPHONE_CALL database table.
 * 
 */
@Entity
@Table(name="V_HOMEPHONE_CALL")
@NamedQuery(name="VHomephoneCall.findAll", query="SELECT v FROM VHomephoneCall v")
public class VHomephoneCall implements Serializable {
