...
/**
 * The persistent class for the CHARGE_REPORT database table.
 * 
 */
@Entity
@Table(name="CHARGE_REPORT")
@NamedQuery(name="ChargeReport.findAll", query="SELECT c FROM ChargeReport c")
