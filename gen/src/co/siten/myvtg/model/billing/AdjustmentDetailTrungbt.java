...
/**
 * The persistent class for the ADJUSTMENT_DETAIL_TRUNGBT database table.
 * 
 */
@Entity
@Table(name="ADJUSTMENT_DETAIL_TRUNGBT")
@NamedQuery(name="AdjustmentDetailTrungbt.findAll", query="SELECT a FROM AdjustmentDetailTrungbt a")
public class AdjustmentDetailTrungbt implements Serializable {
	...
	public AdjustmentDetailTrungbt() {
	}
