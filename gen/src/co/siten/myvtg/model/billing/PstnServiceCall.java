...
/**
 * The persistent class for the PSTN_SERVICE_CALL database table.
 * 
 */
@Entity
@Table(name="PSTN_SERVICE_CALL")
@NamedQuery(name="PstnServiceCall.findAll", query="SELECT p FROM PstnServiceCall p")
public class PstnServiceCall implements Serializable {
