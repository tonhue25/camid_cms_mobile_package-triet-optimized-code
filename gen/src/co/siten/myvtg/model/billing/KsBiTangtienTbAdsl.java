...
/**
 * The persistent class for the KS_BI_TANGTIEN_TB_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_TANGTIEN_TB_ADSL")
@NamedQuery(name="KsBiTangtienTbAdsl.findAll", query="SELECT k FROM KsBiTangtienTbAdsl k")
public class KsBiTangtienTbAdsl implements Serializable {
