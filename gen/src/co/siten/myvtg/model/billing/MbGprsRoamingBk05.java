...
/**
 * The persistent class for the MB_GPRS_ROAMING_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_ROAMING_BK05")
@NamedQuery(name="MbGprsRoamingBk05.findAll", query="SELECT m FROM MbGprsRoamingBk05 m")
public class MbGprsRoamingBk05 implements Serializable {
