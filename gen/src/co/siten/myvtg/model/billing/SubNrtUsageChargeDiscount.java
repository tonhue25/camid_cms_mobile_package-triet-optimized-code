...
/**
 * The persistent class for the SUB_NRT_USAGE_CHARGE_DISCOUNT database table.
 * 
 */
@Entity
@Table(name="SUB_NRT_USAGE_CHARGE_DISCOUNT")
@NamedQuery(name="SubNrtUsageChargeDiscount.findAll", query="SELECT s FROM SubNrtUsageChargeDiscount s")
public class SubNrtUsageChargeDiscount implements Serializable {
	...
	public SubNrtUsageChargeDiscount() {
	}
