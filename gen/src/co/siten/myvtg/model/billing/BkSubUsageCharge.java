...
/**
 * The persistent class for the BK_SUB_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="BK_SUB_USAGE_CHARGE")
@NamedQuery(name="BkSubUsageCharge.findAll", query="SELECT b FROM BkSubUsageCharge b")
public class BkSubUsageCharge implements Serializable {
