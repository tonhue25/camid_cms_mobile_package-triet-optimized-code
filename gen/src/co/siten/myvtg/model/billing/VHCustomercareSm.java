...
/**
 * The persistent class for the V_H_CUSTOMERCARE_SMS database table.
 * 
 */
@Entity
@Table(name="V_H_CUSTOMERCARE_SMS")
@NamedQuery(name="VHCustomercareSm.findAll", query="SELECT v FROM VHCustomercareSm v")
public class VHCustomercareSm implements Serializable {
