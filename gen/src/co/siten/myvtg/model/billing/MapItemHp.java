...
/**
 * The persistent class for the MAP_ITEM_HP database table.
 * 
 */
@Entity
@Table(name="MAP_ITEM_HP")
@NamedQuery(name="MapItemHp.findAll", query="SELECT m FROM MapItemHp m")
public class MapItemHp implements Serializable {
