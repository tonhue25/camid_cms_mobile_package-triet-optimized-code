...
/**
 * The persistent class for the V_P_CUSTOMERCARE_CALL database table.
 * 
 */
@Entity
@Table(name="V_P_CUSTOMERCARE_CALL")
@NamedQuery(name="VPCustomercareCall.findAll", query="SELECT v FROM VPCustomercareCall v")
public class VPCustomercareCall implements Serializable {
