...
/**
 * The persistent class for the SUB_USAGE_CHARGE_HP_LOCK database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_HP_LOCK")
@NamedQuery(name="SubUsageChargeHpLock.findAll", query="SELECT s FROM SubUsageChargeHpLock s")
public class SubUsageChargeHpLock implements Serializable {
