...
/**
 * The persistent class for the V_P_CUSTOMERCARE_VAS database table.
 * 
 */
@Entity
@Table(name="V_P_CUSTOMERCARE_VAS")
@NamedQuery(name="VPCustomercareVa.findAll", query="SELECT v FROM VPCustomercareVa v")
public class VPCustomercareVa implements Serializable {
