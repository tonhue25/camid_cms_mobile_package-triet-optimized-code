...
/**
 * The persistent class for the MB_GPRS database table.
 * 
 */
@Entity
@Table(name="MB_GPRS")
@NamedQuery(name="MbGpr.findAll", query="SELECT m FROM MbGpr m")
public class MbGpr implements Serializable {
