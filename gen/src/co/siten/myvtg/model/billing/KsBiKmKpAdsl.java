...
/**
 * The persistent class for the KS_BI_KM_KP_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_KM_KP_ADSL")
@NamedQuery(name="KsBiKmKpAdsl.findAll", query="SELECT k FROM KsBiKmKpAdsl k")
public class KsBiKmKpAdsl implements Serializable {
