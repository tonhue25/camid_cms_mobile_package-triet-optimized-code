...
/**
 * The persistent class for the PSTN_LOCAL_CALL_MIG_UNRATED database table.
 * 
 */
@Entity
@Table(name="PSTN_LOCAL_CALL_MIG_UNRATED")
@NamedQuery(name="PstnLocalCallMigUnrated.findAll", query="SELECT p FROM PstnLocalCallMigUnrated p")
public class PstnLocalCallMigUnrated implements Serializable {
	...
	public PstnLocalCallMigUnrated() {
	}
