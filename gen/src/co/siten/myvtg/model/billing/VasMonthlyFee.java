...
/**
 * The persistent class for the VAS_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="VAS_MONTHLY_FEE")
@NamedQuery(name="VasMonthlyFee.findAll", query="SELECT v FROM VasMonthlyFee v")
public class VasMonthlyFee implements Serializable {
