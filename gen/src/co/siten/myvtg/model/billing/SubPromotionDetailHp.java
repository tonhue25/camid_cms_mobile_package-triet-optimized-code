...
/**
 * The persistent class for the SUB_PROMOTION_DETAIL_HP database table.
 * 
 */
@Entity
@Table(name="SUB_PROMOTION_DETAIL_HP")
@NamedQuery(name="SubPromotionDetailHp.findAll", query="SELECT s FROM SubPromotionDetailHp s")
public class SubPromotionDetailHp implements Serializable {
