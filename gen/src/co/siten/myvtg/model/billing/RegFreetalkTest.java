...
/**
 * The persistent class for the REG_FREETALK_TEST database table.
 * 
 */
@Entity
@Table(name="REG_FREETALK_TEST")
@NamedQuery(name="RegFreetalkTest.findAll", query="SELECT r FROM RegFreetalkTest r")
public class RegFreetalkTest implements Serializable {
