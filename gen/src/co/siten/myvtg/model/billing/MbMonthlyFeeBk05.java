...
/**
 * The persistent class for the MB_MONTHLY_FEE_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_MONTHLY_FEE_BK05")
@NamedQuery(name="MbMonthlyFeeBk05.findAll", query="SELECT m FROM MbMonthlyFeeBk05 m")
public class MbMonthlyFeeBk05 implements Serializable {
