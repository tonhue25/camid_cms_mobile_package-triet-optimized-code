...
/**
 * The persistent class for the MB_GPRS_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_BK05")
@NamedQuery(name="MbGprsBk05.findAll", query="SELECT m FROM MbGprsBk05 m")
public class MbGprsBk05 implements Serializable {
