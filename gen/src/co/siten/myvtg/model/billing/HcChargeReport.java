...
/**
 * The persistent class for the HC_CHARGE_REPORT database table.
 * 
 */
@Entity
@Table(name="HC_CHARGE_REPORT")
@NamedQuery(name="HcChargeReport.findAll", query="SELECT h FROM HcChargeReport h")
public class HcChargeReport implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private HcChargeReportPK id;
	...
	public HcChargeReport() {
	}

	public HcChargeReportPK getId() {
		return this.id;
	}

	public void setId(HcChargeReportPK id) {
		this.id = id;
	}
