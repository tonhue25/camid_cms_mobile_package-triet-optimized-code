...
/**
 * The persistent class for the SUB_USAGE_CHARGE3 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE3")
@NamedQuery(name="SubUsageCharge3.findAll", query="SELECT s FROM SubUsageCharge3 s")
public class SubUsageCharge3 implements Serializable {
