...
/**
 * The persistent class for the MB_GPRS_BK_052016 database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_BK_052016")
@NamedQuery(name="MbGprsBk052016.findAll", query="SELECT m FROM MbGprsBk052016 m")
public class MbGprsBk052016 implements Serializable {
