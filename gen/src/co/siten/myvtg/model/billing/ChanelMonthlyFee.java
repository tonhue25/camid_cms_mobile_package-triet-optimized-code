...
/**
 * The persistent class for the CHANEL_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="CHANEL_MONTHLY_FEE")
@NamedQuery(name="ChanelMonthlyFee.findAll", query="SELECT c FROM ChanelMonthlyFee c")
public class ChanelMonthlyFee implements Serializable {
