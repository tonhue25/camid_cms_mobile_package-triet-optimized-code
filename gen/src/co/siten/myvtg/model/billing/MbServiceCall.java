...
/**
 * The persistent class for the MB_SERVICE_CALL database table.
 * 
 */
@Entity
@Table(name="MB_SERVICE_CALL")
@NamedQuery(name="MbServiceCall.findAll", query="SELECT m FROM MbServiceCall m")
public class MbServiceCall implements Serializable {
