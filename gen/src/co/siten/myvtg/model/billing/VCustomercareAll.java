...
/**
 * The persistent class for the V_CUSTOMERCARE_ALL database table.
 * 
 */
@Entity
@Table(name="V_CUSTOMERCARE_ALL")
@NamedQuery(name="VCustomercareAll.findAll", query="SELECT v FROM VCustomercareAll v")
public class VCustomercareAll implements Serializable {
