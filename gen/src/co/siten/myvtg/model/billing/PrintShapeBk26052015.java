...
/**
 * The persistent class for the PRINT_SHAPE_BK26052015 database table.
 * 
 */
@Entity
@Table(name="PRINT_SHAPE_BK26052015")
@NamedQuery(name="PrintShapeBk26052015.findAll", query="SELECT p FROM PrintShapeBk26052015 p")
public class PrintShapeBk26052015 implements Serializable {
