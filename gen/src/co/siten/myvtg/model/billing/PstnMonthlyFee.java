...
/**
 * The persistent class for the PSTN_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="PSTN_MONTHLY_FEE")
@NamedQuery(name="PstnMonthlyFee.findAll", query="SELECT p FROM PstnMonthlyFee p")
public class PstnMonthlyFee implements Serializable {
