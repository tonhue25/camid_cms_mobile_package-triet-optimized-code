...
/**
 * The persistent class for the SYNTHETIC_MOBILE_TV_NHANNC database table.
 * 
 */
@Entity
@Table(name="SYNTHETIC_MOBILE_TV_NHANNC")
@NamedQuery(name="SyntheticMobileTvNhannc.findAll", query="SELECT s FROM SyntheticMobileTvNhannc s")
public class SyntheticMobileTvNhannc implements Serializable {
	...
	public SyntheticMobileTvNhannc() {
	}
