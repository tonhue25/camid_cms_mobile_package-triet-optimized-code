...
/**
 * The persistent class for the PRINT_SHAPE_BK29052015 database table.
 * 
 */
@Entity
@Table(name="PRINT_SHAPE_BK29052015")
@NamedQuery(name="PrintShapeBk29052015.findAll", query="SELECT p FROM PrintShapeBk29052015 p")
public class PrintShapeBk29052015 implements Serializable {
