...
/**
 * The persistent class for the V_H_CUSTOMERCARE_VAS database table.
 * 
 */
@Entity
@Table(name="V_H_CUSTOMERCARE_VAS")
@NamedQuery(name="VHCustomercareVa.findAll", query="SELECT v FROM VHCustomercareVa v")
public class VHCustomercareVa implements Serializable {
