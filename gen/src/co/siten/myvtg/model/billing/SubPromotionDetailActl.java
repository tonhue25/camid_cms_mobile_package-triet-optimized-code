...
/**
 * The persistent class for the SUB_PROMOTION_DETAIL_ACTL database table.
 * 
 */
@Entity
@Table(name="SUB_PROMOTION_DETAIL_ACTL")
@NamedQuery(name="SubPromotionDetailActl.findAll", query="SELECT s FROM SubPromotionDetailActl s")
public class SubPromotionDetailActl implements Serializable {
