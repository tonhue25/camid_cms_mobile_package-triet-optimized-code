...
/**
 * The persistent class for the V_MB_CUSTOMERCARE_VAS database table.
 * 
 */
@Entity
@Table(name="V_MB_CUSTOMERCARE_VAS")
@NamedQuery(name="VMbCustomercareVa.findAll", query="SELECT v FROM VMbCustomercareVa v")
public class VMbCustomercareVa implements Serializable {
