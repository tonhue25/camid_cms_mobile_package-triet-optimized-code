...
/**
 * The persistent class for the HC_CLOSE_ERROR database table.
 * 
 */
@Entity
@Table(name="HC_CLOSE_ERROR")
@NamedQuery(name="HcCloseError.findAll", query="SELECT h FROM HcCloseError h")
public class HcCloseError implements Serializable {
