...
/**
 * The persistent class for the HP_LOCAL_CALL database table.
 * 
 */
@Entity
@Table(name="HP_LOCAL_CALL")
@NamedQuery(name="HpLocalCall.findAll", query="SELECT h FROM HpLocalCall h")
public class HpLocalCall implements Serializable {
