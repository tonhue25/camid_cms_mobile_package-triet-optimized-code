...
/**
 * The persistent class for the ADSL_VAS_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="ADSL_VAS_MONTHLY_FEE")
@NamedQuery(name="AdslVasMonthlyFee.findAll", query="SELECT a FROM AdslVasMonthlyFee a")
public class AdslVasMonthlyFee implements Serializable {
