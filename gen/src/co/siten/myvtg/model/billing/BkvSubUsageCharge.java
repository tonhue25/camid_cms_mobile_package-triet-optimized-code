...
/**
 * The persistent class for the BKV_SUB_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="BKV_SUB_USAGE_CHARGE")
@NamedQuery(name="BkvSubUsageCharge.findAll", query="SELECT b FROM BkvSubUsageCharge b")
public class BkvSubUsageCharge implements Serializable {
