...
/**
 * The persistent class for the KS_BI_KM_TANGTIEN_TB_PS_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_KM_TANGTIEN_TB_PS_ADSL")
@NamedQuery(name="KsBiKmTangtienTbPsAdsl.findAll", query="SELECT k FROM KsBiKmTangtienTbPsAdsl k")
public class KsBiKmTangtienTbPsAdsl implements Serializable {
	...
	@Column(name="P_PHATSINH")
	private BigDecimal pPhatsinh;
	...
	@Column(name="P_THUEBAO")
	private BigDecimal pThuebao;

	private BigDecimal status;

	public KsBiKmTangtienTbPsAdsl() {
	}
	...
	public BigDecimal getPPhatsinh() {
		return this.pPhatsinh;
	}

	public void setPPhatsinh(BigDecimal pPhatsinh) {
		this.pPhatsinh = pPhatsinh;
	}
	...
	public BigDecimal getPThuebao() {
		return this.pThuebao;
	}

	public void setPThuebao(BigDecimal pThuebao) {
		this.pThuebao = pThuebao;
	}
