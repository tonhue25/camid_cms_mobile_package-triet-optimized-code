...
/**
 * The persistent class for the PRINT_SHAPE_TABLE_BK26052015 database table.
 * 
 */
@Entity
@Table(name="PRINT_SHAPE_TABLE_BK26052015")
@NamedQuery(name="PrintShapeTableBk26052015.findAll", query="SELECT p FROM PrintShapeTableBk26052015 p")
public class PrintShapeTableBk26052015 implements Serializable {
	...
	public PrintShapeTableBk26052015() {
	}
