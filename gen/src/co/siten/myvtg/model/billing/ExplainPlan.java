...
/**
 * The persistent class for the EXPLAIN_PLAN database table.
 * 
 */
@Entity
@Table(name="EXPLAIN_PLAN")
@NamedQuery(name="ExplainPlan.findAll", query="SELECT e FROM ExplainPlan e")
public class ExplainPlan implements Serializable {
