...
/**
 * The persistent class for the UD_KMT8_USAGE database table.
 * 
 */
@Entity
@Table(name="UD_KMT8_USAGE")
@NamedQuery(name="UdKmt8Usage.findAll", query="SELECT u FROM UdKmt8Usage u")
public class UdKmt8Usage implements Serializable {
