...
/**
 * The persistent class for the LECH_FREEZE_A database table.
 * 
 */
@Entity
@Table(name="LECH_FREEZE_A")
@NamedQuery(name="LechFreezeA.findAll", query="SELECT l FROM LechFreezeA l")
public class LechFreezeA implements Serializable {
