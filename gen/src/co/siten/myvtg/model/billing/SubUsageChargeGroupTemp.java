...
/**
 * The persistent class for the SUB_USAGE_CHARGE_GROUP_TEMP database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_GROUP_TEMP")
@NamedQuery(name="SubUsageChargeGroupTemp.findAll", query="SELECT s FROM SubUsageChargeGroupTemp s")
public class SubUsageChargeGroupTemp implements Serializable {
	...
	public SubUsageChargeGroupTemp() {
	}
