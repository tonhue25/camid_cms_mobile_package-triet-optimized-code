...
/**
 * The persistent class for the HP_MONTHLY_FEE_TEMP database table.
 * 
 */
@Entity
@Table(name="HP_MONTHLY_FEE_TEMP")
@NamedQuery(name="HpMonthlyFeeTemp.findAll", query="SELECT h FROM HpMonthlyFeeTemp h")
public class HpMonthlyFeeTemp implements Serializable {
