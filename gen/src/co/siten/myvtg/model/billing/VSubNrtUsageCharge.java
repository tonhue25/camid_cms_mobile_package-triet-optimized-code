...
/**
 * The persistent class for the V_SUB_NRT_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="V_SUB_NRT_USAGE_CHARGE")
@NamedQuery(name="VSubNrtUsageCharge.findAll", query="SELECT v FROM VSubNrtUsageCharge v")
public class VSubNrtUsageCharge implements Serializable {
