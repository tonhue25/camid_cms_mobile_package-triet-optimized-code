...
/**
 * The persistent class for the GENERAL_MEMBER_BK161124 database table.
 * 
 */
@Entity
@Table(name="GENERAL_MEMBER_BK161124")
@NamedQuery(name="GeneralMemberBk161124.findAll", query="SELECT g FROM GeneralMemberBk161124 g")
public class GeneralMemberBk161124 implements Serializable {
