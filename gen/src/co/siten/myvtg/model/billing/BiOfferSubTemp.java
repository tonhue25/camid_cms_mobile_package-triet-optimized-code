...
/**
 * The persistent class for the BI_OFFER_SUB_TEMP database table.
 * 
 */
@Entity
@Table(name="BI_OFFER_SUB_TEMP")
@NamedQuery(name="BiOfferSubTemp.findAll", query="SELECT b FROM BiOfferSubTemp b")
public class BiOfferSubTemp implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	@Column(name="OFFER_SUB_ID")
	private long offerSubId;
	...
	public BiOfferSubTemp() {
	}

	public long getOfferSubId() {
		return this.offerSubId;
	}

	public void setOfferSubId(long offerSubId) {
