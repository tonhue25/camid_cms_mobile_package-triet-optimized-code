...
/**
 * The persistent class for the MB_POSTPAID_CALL_BK database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL_BK")
@NamedQuery(name="MbPostpaidCallBk.findAll", query="SELECT m FROM MbPostpaidCallBk m")
public class MbPostpaidCallBk implements Serializable {
