...
/**
 * The persistent class for the TRACE_FILE_INFO_IMPORT_ERROR database table.
 * 
 */
@Entity
@Table(name="TRACE_FILE_INFO_IMPORT_ERROR")
@NamedQuery(name="TraceFileInfoImportError.findAll", query="SELECT t FROM TraceFileInfoImportError t")
public class TraceFileInfoImportError implements Serializable {
	...
	public TraceFileInfoImportError() {
	}
