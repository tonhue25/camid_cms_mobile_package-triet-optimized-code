...
/**
 * The persistent class for the SUB_USAGE_CHARGE8 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE8")
@NamedQuery(name="SubUsageCharge8.findAll", query="SELECT s FROM SubUsageCharge8 s")
public class SubUsageCharge8 implements Serializable {
