...
/**
 * The persistent class for the PSTN_LOCAL_CALL database table.
 * 
 */
@Entity
@Table(name="PSTN_LOCAL_CALL")
@NamedQuery(name="PstnLocalCall.findAll", query="SELECT p FROM PstnLocalCall p")
public class PstnLocalCall implements Serializable {
