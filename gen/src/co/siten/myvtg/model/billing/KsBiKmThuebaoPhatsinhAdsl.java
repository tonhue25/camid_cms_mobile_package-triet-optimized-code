...
/**
 * The persistent class for the KS_BI_KM_THUEBAO_PHATSINH_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_KM_THUEBAO_PHATSINH_ADSL")
@NamedQuery(name="KsBiKmThuebaoPhatsinhAdsl.findAll", query="SELECT k FROM KsBiKmThuebaoPhatsinhAdsl k")
public class KsBiKmThuebaoPhatsinhAdsl implements Serializable {
	...
	public KsBiKmThuebaoPhatsinhAdsl() {
	}
