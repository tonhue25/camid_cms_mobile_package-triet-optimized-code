...
/**
 * The persistent class for the KS_SUM_MB_POSTPAID_CALL_DTL database table.
 * 
 */
@Entity
@Table(name="KS_SUM_MB_POSTPAID_CALL_DTL")
@NamedQuery(name="KsSumMbPostpaidCallDtl.findAll", query="SELECT k FROM KsSumMbPostpaidCallDtl k")
public class KsSumMbPostpaidCallDtl implements Serializable {
