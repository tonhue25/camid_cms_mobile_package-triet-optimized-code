...
/**
 * The persistent class for the MB_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="MB_MONTHLY_FEE")
@NamedQuery(name="MbMonthlyFee.findAll", query="SELECT m FROM MbMonthlyFee m")
public class MbMonthlyFee implements Serializable {
