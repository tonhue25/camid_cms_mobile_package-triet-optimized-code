...
/**
 * The persistent class for the V_SUB_USAGE_CHARGE database table.
 * 
 */
@Entity
@Table(name="V_SUB_USAGE_CHARGE")
@NamedQuery(name="VSubUsageCharge.findAll", query="SELECT v FROM VSubUsageCharge v")
public class VSubUsageCharge implements Serializable {
