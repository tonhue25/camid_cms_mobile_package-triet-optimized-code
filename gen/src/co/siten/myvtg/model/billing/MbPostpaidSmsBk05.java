...
/**
 * The persistent class for the MB_POSTPAID_SMS_BK05 database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_SMS_BK05")
@NamedQuery(name="MbPostpaidSmsBk05.findAll", query="SELECT m FROM MbPostpaidSmsBk05 m")
public class MbPostpaidSmsBk05 implements Serializable {
