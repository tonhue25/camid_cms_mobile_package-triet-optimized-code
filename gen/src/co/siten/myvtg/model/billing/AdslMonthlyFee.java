...
/**
 * The persistent class for the ADSL_MONTHLY_FEE database table.
 * 
 */
@Entity
@Table(name="ADSL_MONTHLY_FEE")
@NamedQuery(name="AdslMonthlyFee.findAll", query="SELECT a FROM AdslMonthlyFee a")
public class AdslMonthlyFee implements Serializable {
