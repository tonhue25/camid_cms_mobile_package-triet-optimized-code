...
/**
 * The persistent class for the SUB_USAGE_CHARGE_TEMP2_1T database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_TEMP2_1T")
@NamedQuery(name="SubUsageChargeTemp21t.findAll", query="SELECT s FROM SubUsageChargeTemp21t s")
public class SubUsageChargeTemp21t implements Serializable {
