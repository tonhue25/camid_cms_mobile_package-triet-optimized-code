...
/**
 * The persistent class for the KS_BI_KM_DONGTIEN_CODINH_ADSL database table.
 * 
 */
@Entity
@Table(name="KS_BI_KM_DONGTIEN_CODINH_ADSL")
@NamedQuery(name="KsBiKmDongtienCodinhAdsl.findAll", query="SELECT k FROM KsBiKmDongtienCodinhAdsl k")
public class KsBiKmDongtienCodinhAdsl implements Serializable {
	private static final long serialVersionUID = 1L;

	private BigDecimal id;

	@Column(name="IS_TAXED")
	private BigDecimal isTaxed;
	...
	public KsBiKmDongtienCodinhAdsl() {
	}
	...
	public BigDecimal getIsTaxed() {
		return this.isTaxed;
	}

	public void setIsTaxed(BigDecimal isTaxed) {
