...
/**
 * The persistent class for the SUB_PROMOTION_DETAIL_FINAL database table.
 * 
 */
@Entity
@Table(name="SUB_PROMOTION_DETAIL_FINAL")
@NamedQuery(name="SubPromotionDetailFinal.findAll", query="SELECT s FROM SubPromotionDetailFinal s")
public class SubPromotionDetailFinal implements Serializable {
	...
	public SubPromotionDetailFinal() {
	}
