...
/**
 * The persistent class for the HP_POSTPAID_CALL database table.
 * 
 */
@Entity
@Table(name="HP_POSTPAID_CALL")
@NamedQuery(name="HpPostpaidCall.findAll", query="SELECT h FROM HpPostpaidCall h")
public class HpPostpaidCall implements Serializable {
