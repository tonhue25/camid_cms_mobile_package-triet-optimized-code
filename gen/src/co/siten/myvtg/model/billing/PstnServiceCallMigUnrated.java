...
/**
 * The persistent class for the PSTN_SERVICE_CALL_MIG_UNRATED database table.
 * 
 */
@Entity
@Table(name="PSTN_SERVICE_CALL_MIG_UNRATED")
@NamedQuery(name="PstnServiceCallMigUnrated.findAll", query="SELECT p FROM PstnServiceCallMigUnrated p")
public class PstnServiceCallMigUnrated implements Serializable {
	...
	public PstnServiceCallMigUnrated() {
	}
