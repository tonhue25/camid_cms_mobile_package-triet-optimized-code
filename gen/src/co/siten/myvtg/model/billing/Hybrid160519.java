...
/**
 * The persistent class for the HYBRID_160519 database table.
 * 
 */
@Entity
@Table(name="HYBRID_160519")
@NamedQuery(name="Hybrid160519.findAll", query="SELECT h FROM Hybrid160519 h")
public class Hybrid160519 implements Serializable {
