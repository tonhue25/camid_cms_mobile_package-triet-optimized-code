...
/**
 * The persistent class for the MB_GPRS_ROAMING database table.
 * 
 */
@Entity
@Table(name="MB_GPRS_ROAMING")
@NamedQuery(name="MbGprsRoaming.findAll", query="SELECT m FROM MbGprsRoaming m")
public class MbGprsRoaming implements Serializable {
