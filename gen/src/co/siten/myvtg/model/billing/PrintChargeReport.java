...
/**
 * The persistent class for the PRINT_CHARGE_REPORT database table.
 * 
 */
@Entity
@Table(name="PRINT_CHARGE_REPORT")
@NamedQuery(name="PrintChargeReport.findAll", query="SELECT p FROM PrintChargeReport p")
public class PrintChargeReport implements Serializable {
	...
	@Column(name="END_OF_CYCLE")
	private String endOfCycle;
	...
	@Column(name="PAY_BEFORE2")
	private String payBefore2;
	...
	@Column(name="SERVICE_TYPES2")
	private String serviceTypes2;
	...
	@Column(name="TOT_CHARGE_NO_TAX")
	private BigDecimal totChargeNoTax;

	@Column(name="\"TYPE\"")
	private String type;

	public PrintChargeReport() {
	}
	...
	public String getEndOfCycle() {
		return this.endOfCycle;
	}

	public void setEndOfCycle(String endOfCycle) {
	...
	public String getPayBefore2() {
		return this.payBefore2;
	}

	public void setPayBefore2(String payBefore2) {
		this.payBefore2 = payBefore2;
	}
	...
	public String getServiceTypes2() {
		return this.serviceTypes2;
	}

	public void setServiceTypes2(String serviceTypes2) {
		this.serviceTypes2 = serviceTypes2;
	}
	...
	public BigDecimal getTotChargeNoTax() {
		return this.totChargeNoTax;
	}

	public void setTotChargeNoTax(BigDecimal totChargeNoTax) {
		this.totChargeNoTax = totChargeNoTax;
	}
