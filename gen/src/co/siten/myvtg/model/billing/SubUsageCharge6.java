...
/**
 * The persistent class for the SUB_USAGE_CHARGE6 database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE6")
@NamedQuery(name="SubUsageCharge6.findAll", query="SELECT s FROM SubUsageCharge6 s")
public class SubUsageCharge6 implements Serializable {
