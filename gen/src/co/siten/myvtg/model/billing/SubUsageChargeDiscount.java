...
/**
 * The persistent class for the SUB_USAGE_CHARGE_DISCOUNT database table.
 * 
 */
@Entity
@Table(name="SUB_USAGE_CHARGE_DISCOUNT")
@NamedQuery(name="SubUsageChargeDiscount.findAll", query="SELECT s FROM SubUsageChargeDiscount s")
public class SubUsageChargeDiscount implements Serializable {
