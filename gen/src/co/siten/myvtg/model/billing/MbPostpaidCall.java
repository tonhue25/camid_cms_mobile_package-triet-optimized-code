...
/**
 * The persistent class for the MB_POSTPAID_CALL database table.
 * 
 */
@Entity
@Table(name="MB_POSTPAID_CALL")
@NamedQuery(name="MbPostpaidCall.findAll", query="SELECT m FROM MbPostpaidCall m")
public class MbPostpaidCall implements Serializable {
