...
/**
 * The persistent class for the HP_UPDATE_PO_CODE database table.
 * 
 */
@Entity
@Table(name="HP_UPDATE_PO_CODE")
@NamedQuery(name="HpUpdatePoCode.findAll", query="SELECT h FROM HpUpdatePoCode h")
public class HpUpdatePoCode implements Serializable {
	...
	@Column(name="THUY_PO_CODE")
	private String thuyPoCode;

	@Column(name="\"TYPE\"")
	private String type;

	public HpUpdatePoCode() {
	}
	...
	public String getThuyPoCode() {
		return this.thuyPoCode;
	}

	public void setThuyPoCode(String thuyPoCode) {
		this.thuyPoCode = thuyPoCode;
	}
