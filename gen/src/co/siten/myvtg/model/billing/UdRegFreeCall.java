...
/**
 * The persistent class for the UD_REG_FREE_CALL database table.
 * 
 */
@Entity
@Table(name="UD_REG_FREE_CALL")
@NamedQuery(name="UdRegFreeCall.findAll", query="SELECT u FROM UdRegFreeCall u")
public class UdRegFreeCall implements Serializable {
