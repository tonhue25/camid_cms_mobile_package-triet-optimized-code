...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_OFFLINE database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_OFFLINE")
@NamedQuery(name="ViewCcSubCustMbOffline.findAll", query="SELECT v FROM ViewCcSubCustMbOffline v")
public class ViewCcSubCustMbOffline implements Serializable {
