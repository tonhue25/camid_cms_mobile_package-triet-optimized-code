...
/**
 * The persistent class for the COMMAND_SERVICE_HLR database table.
 * 
 */
@Entity
@Table(name="COMMAND_SERVICE_HLR")
@NamedQuery(name="CommandServiceHlr.findAll", query="SELECT c FROM CommandServiceHlr c")
public class CommandServiceHlr implements Serializable {
