...
/**
 * The persistent class for the PC_ZONE database table.
 * 
 */
@Entity
@Table(name="PC_ZONE")
@NamedQuery(name="PcZone.findAll", query="SELECT p FROM PcZone p")
public class PcZone implements Serializable {
