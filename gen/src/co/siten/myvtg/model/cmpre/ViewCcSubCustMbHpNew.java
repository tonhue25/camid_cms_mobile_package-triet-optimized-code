...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_HP_NEW database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_HP_NEW")
@NamedQuery(name="ViewCcSubCustMbHpNew.findAll", query="SELECT v FROM ViewCcSubCustMbHpNew v")
public class ViewCcSubCustMbHpNew implements Serializable {
