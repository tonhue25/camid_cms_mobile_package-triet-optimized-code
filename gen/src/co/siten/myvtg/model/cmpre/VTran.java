...
/**
 * The persistent class for the V_TRANS database table.
 * 
 */
@Entity
@Table(name="V_TRANS")
@NamedQuery(name="VTran.findAll", query="SELECT v FROM VTran v")
public class VTran implements Serializable {
