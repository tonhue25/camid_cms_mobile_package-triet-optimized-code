...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_HP_OFFLINE database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_HP_OFFLINE")
@NamedQuery(name="ViewCcSubCustHpOffline.findAll", query="SELECT v FROM ViewCcSubCustHpOffline v")
public class ViewCcSubCustHpOffline implements Serializable {
