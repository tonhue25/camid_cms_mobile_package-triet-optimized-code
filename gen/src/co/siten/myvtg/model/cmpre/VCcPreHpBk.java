...
/**
 * The persistent class for the V_CC_PRE_HP_BK database table.
 * 
 */
@Entity
@Table(name="V_CC_PRE_HP_BK")
@NamedQuery(name="VCcPreHpBk.findAll", query="SELECT v FROM VCcPreHpBk v")
public class VCcPreHpBk implements Serializable {
