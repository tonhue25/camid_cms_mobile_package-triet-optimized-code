...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_LIST database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_LIST")
@NamedQuery(name="ViewCcSubCustMbList.findAll", query="SELECT v FROM ViewCcSubCustMbList v")
public class ViewCcSubCustMbList implements Serializable {
	...
	public Timestamp getCustBirth() {
		return this.custBirth;
	}

	public void setCustBirth(Timestamp custBirth) {
	...
	public String getHlrStatusName() {
		return this.hlrStatusName;
	}

	public void setHlrStatusName(String hlrStatusName) {
