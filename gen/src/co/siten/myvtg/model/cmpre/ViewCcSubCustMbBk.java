...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_BK database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_BK")
@NamedQuery(name="ViewCcSubCustMbBk.findAll", query="SELECT v FROM ViewCcSubCustMbBk v")
public class ViewCcSubCustMbBk implements Serializable {
