...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_HP_OFFLINE database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_HP_OFFLINE")
@NamedQuery(name="ViewCcSubCustMbHpOffline.findAll", query="SELECT v FROM ViewCcSubCustMbHpOffline v")
public class ViewCcSubCustMbHpOffline implements Serializable {
	...
	public ViewCcSubCustMbHpOffline() {
	}
