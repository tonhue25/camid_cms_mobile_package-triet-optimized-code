...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_SUBSCRIBER database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_SUBSCRIBER")
@NamedQuery(name="ViewCcSubCustMbSubscriber.findAll", query="SELECT v FROM ViewCcSubCustMbSubscriber v")
public class ViewCcSubCustMbSubscriber implements Serializable {
	...
	public ViewCcSubCustMbSubscriber() {
	}
