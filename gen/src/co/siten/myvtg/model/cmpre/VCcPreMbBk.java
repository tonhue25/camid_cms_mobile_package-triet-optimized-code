...
/**
 * The persistent class for the V_CC_PRE_MB_BK database table.
 * 
 */
@Entity
@Table(name="V_CC_PRE_MB_BK")
@NamedQuery(name="VCcPreMbBk.findAll", query="SELECT v FROM VCcPreMbBk v")
public class VCcPreMbBk implements Serializable {
