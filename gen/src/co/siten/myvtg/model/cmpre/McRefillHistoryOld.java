...
/**
 * The persistent class for the MC_REFILL_HISTORY_OLD database table.
 * 
 */
@Entity
@Table(name="MC_REFILL_HISTORY_OLD")
@NamedQuery(name="McRefillHistoryOld.findAll", query="SELECT m FROM McRefillHistoryOld m")
public class McRefillHistoryOld implements Serializable {
