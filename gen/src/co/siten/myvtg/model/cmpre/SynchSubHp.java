...
/**
 * The persistent class for the SYNCH_SUB_HP database table.
 * 
 */
@Entity
@Table(name="SYNCH_SUB_HP")
@NamedQuery(name="SynchSubHp.findAll", query="SELECT s FROM SynchSubHp s")
public class SynchSubHp implements Serializable {
