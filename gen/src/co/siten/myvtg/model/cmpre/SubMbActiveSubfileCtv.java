...
/**
 * The persistent class for the SUB_MB_ACTIVE_SUBFILE_CTV database table.
 * 
 */
@Entity
@Table(name="SUB_MB_ACTIVE_SUBFILE_CTV")
@NamedQuery(name="SubMbActiveSubfileCtv.findAll", query="SELECT s FROM SubMbActiveSubfileCtv s")
public class SubMbActiveSubfileCtv implements Serializable {
