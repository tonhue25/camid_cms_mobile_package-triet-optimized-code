...
/**
 * The persistent class for the VIEW_HLR_HP database table.
 * 
 */
@Entity
@Table(name="VIEW_HLR_HP")
@NamedQuery(name="ViewHlrHp.findAll", query="SELECT v FROM ViewHlrHp v")
public class ViewHlrHp implements Serializable {
