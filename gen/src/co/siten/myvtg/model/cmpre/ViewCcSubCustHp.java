...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_HP database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_HP")
@NamedQuery(name="ViewCcSubCustHp.findAll", query="SELECT v FROM ViewCcSubCustHp v")
public class ViewCcSubCustHp implements Serializable {
