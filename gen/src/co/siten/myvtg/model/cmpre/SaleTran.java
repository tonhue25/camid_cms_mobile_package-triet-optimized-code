...
/**
 * The persistent class for the SALE_TRANS database table.
 * 
 */
@Entity
@Table(name="SALE_TRANS")
@NamedQuery(name="SaleTran.findAll", query="SELECT s FROM SaleTran s")
public class SaleTran implements Serializable {
	...
	@Lob
	@Column(name="LST_STOCK_ISDN")
	private byte[] lstStockIsdn;

	@Lob
	@Column(name="LST_STOCK_SIM")
	private byte[] lstStockSim;
	...
	public byte[] getLstStockIsdn() {
		return this.lstStockIsdn;
	}

	public void setLstStockIsdn(byte[] lstStockIsdn) {
		this.lstStockIsdn = lstStockIsdn;
	}

	public byte[] getLstStockSim() {
		return this.lstStockSim;
	}

	public void setLstStockSim(byte[] lstStockSim) {
