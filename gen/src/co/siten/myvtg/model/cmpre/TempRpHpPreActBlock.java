...
/**
 * The persistent class for the TEMP_RP_HP_PRE_ACT_BLOCK database table.
 * 
 */
@Entity
@Table(name="TEMP_RP_HP_PRE_ACT_BLOCK")
@NamedQuery(name="TempRpHpPreActBlock.findAll", query="SELECT t FROM TempRpHpPreActBlock t")
public class TempRpHpPreActBlock implements Serializable {
