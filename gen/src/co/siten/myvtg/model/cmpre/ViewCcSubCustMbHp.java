...
/**
 * The persistent class for the VIEW_CC_SUB_CUST_MB_HP database table.
 * 
 */
@Entity
@Table(name="VIEW_CC_SUB_CUST_MB_HP")
@NamedQuery(name="ViewCcSubCustMbHp.findAll", query="SELECT v FROM ViewCcSubCustMbHp v")
public class ViewCcSubCustMbHp implements Serializable {
