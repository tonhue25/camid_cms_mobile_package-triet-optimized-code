...
/**
 * The persistent class for the MC_REFILL_HISTORY_ERR database table.
 * 
 */
@Entity
@Table(name="MC_REFILL_HISTORY_ERR")
@NamedQuery(name="McRefillHistoryErr.findAll", query="SELECT m FROM McRefillHistoryErr m")
public class McRefillHistoryErr implements Serializable {
