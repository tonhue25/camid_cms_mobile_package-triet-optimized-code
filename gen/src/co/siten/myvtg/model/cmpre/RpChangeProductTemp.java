...
/**
 * The persistent class for the RP_CHANGE_PRODUCT_TEMP database table.
 * 
 */
@Entity
@Table(name="RP_CHANGE_PRODUCT_TEMP")
@NamedQuery(name="RpChangeProductTemp.findAll", query="SELECT r FROM RpChangeProductTemp r")
public class RpChangeProductTemp implements Serializable {
