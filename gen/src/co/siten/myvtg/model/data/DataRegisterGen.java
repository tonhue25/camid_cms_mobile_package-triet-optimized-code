...
/**
 * The persistent class for the DATA_REGISTER_GEN database table.
 * 
 */
@Entity
@Table(name="DATA_REGISTER_GEN")
@NamedQuery(name="DataRegisterGen.findAll", query="SELECT d FROM DataRegisterGen d")
public class DataRegisterGen implements Serializable {
