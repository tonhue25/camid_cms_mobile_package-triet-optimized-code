...
public class OfferSub implements Serializable {
	...
	public OfferSub(OfferSub o) {
		super();
		this.balShareId = o.balShareId;
		this.contractOfferId = o.contractOfferId;
		this.dbModiDatetime = o.dbModiDatetime;
		this.dbStaDatetime = o.dbStaDatetime;
		this.endDatetime = o.endDatetime;
		this.endZteLogId = o.endZteLogId;
		this.inModiDatetime = o.inModiDatetime;
		this.inStaDatetime = o.inStaDatetime;
		this.isNewSub = o.isNewSub;
		this.main = o.main;
		this.payLimit = o.payLimit;
		this.payMethod = o.payMethod;
		this.productId = o.productId;
		this.speedDialNumber = o.speedDialNumber;
		this.staDatetime = o.staDatetime;
		this.status = o.status;
		this.subId = o.subId;
		this.telService = o.telService;
		this.zteLogId = o.zteLogId;
	}
