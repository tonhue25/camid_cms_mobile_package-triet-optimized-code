...
public class ActionDetail implements Serializable {
	...
	@SequenceGenerator(name = "SEQ", sequenceName = Config.SEQUENCE_CM_PRE_ACTION_DETAIL, allocationSize = 1)
	...
	public ActionDetail(BigDecimal actionAuditId, String colName, Date issueDatetime, String newValue, String oldValue,
			BigDecimal rowId, String tableName) {
		super();
