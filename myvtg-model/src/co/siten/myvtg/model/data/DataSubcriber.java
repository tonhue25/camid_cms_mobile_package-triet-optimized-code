...
/**
 * The persistent class for the DATA_SUBCRIBER database table.
 * 
 */
@Entity
@Table(name="DATA_SUBCRIBER" )
@NamedQuery(name="DataSubcriber.findAll", query="SELECT d FROM DataSubcriber d")
public class DataSubcriber implements Serializable {
