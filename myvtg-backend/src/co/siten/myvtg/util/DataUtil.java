...
public class DataUtil {
    ...
    public static String nullOrValueS(Object object){

        return DataUtil.isNullObject(object) ? null : object.toString();
    }

    public static Integer nullOrValueI(Object object){
        return DataUtil.isNullObject(object) ? null : Integer.parseInt(object.toString());
    }

    public static Long nullOrValueL(Object object){
        return DataUtil.isNullObject(object) ? null : Long.parseLong(object.toString());
    }

    public static BigDecimal nullOrValueB(Object object){
        return DataUtil.isNullObject(object) ? null : BigDecimal.valueOf(Long.parseLong(object.toString()));
    }
    ...
    public static String fomatIsdn(String isdn) {
        ...
        isdnFm = isdnFm.startsWith("00855") ? isdnFm.substring(5) : isdnFm;
    ...
    public static String fomatIsdn855(String isdn) {
        ...
        if (isdnFm.startsWith("00855")) {
            return isdnFm.substring(2);
...
//    }
    ...
    public static boolean isNullOrEmpty(Long lng) {
        String str = parseToString(lng);
        return str == null || str.isEmpty() || str.matches(RegexUtil.CHECK_SPACE);
    }

    public static boolean isNullOrEmpty(Integer inter) {
        String str = parseToString(inter);
        return str == null || str.isEmpty() || str.matches(RegexUtil.CHECK_SPACE);
    }
     ...
     * @param cs String
     * @return boolean
     * @author daibq check null or empty Su dung ma nguon cua thu vien StringUtils trong
     * apache common lang
     */
...
//        cal.set(Calendar.YEAR, year);
    ...
    /**
     * convertJsonStringToHashMap
     *
     * @param json
     * @return
     */
    public static Map<String, Object> convertJsonStringToHashMap(final String json) {
        try {
    ...
    public static String formatIsdn0(String isdn) {
        if (isNullOrEmpty(isdn)) {
            return "";
        }
        String isdnFm = isdn.replaceAll("\\s+", "").trim();
    ...
    public static String formatIsdn0With3Diditals(String isdn) {
        if (isNullOrEmpty(isdn)) {
            return "";
        }
        String isdnFm = isdn.replaceAll("\\s+", "").trim();
        ...
        isdnFm = "0" + isdnFm;
        isdnFm = isdnFm.substring(0, 3) + " " + isdnFm.substring(3);
...
//        System.out.println(a.toString());
        //1599670800000
        //1599670800286
        String a = "855886137778";
        System.out.print(formatIsdn0With3Diditals(a));
    }
