...
import com.viettel.bccs.cm.database.DAO.Webservice.Pr.ProConfig;
import com.viettel.bccs.cm.database.DAO.Webservice.Pr.ProvisioningUtils;
 ...
 *
 * @Author : TuanTM11
 * @CreateDate : 05 - 06 - 2012
 * @Purpose : Giao diện gửi lệnh đấu nối lên Provisioning
 */
